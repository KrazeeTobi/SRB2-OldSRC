...
//#endif
#if defined (_WIN32) || defined (SDLIO) || defined (UNIXLIKE) || defined (__MACH__) || defined (_WIN64)
#define LOGMESSAGES // write message in log.txt (win32/win64/Mach/Unix-like/SDLIO-using only for the moment)
#endif
...
#define VERSIONSTRING " v1.09.3.22"
...
#if (defined (UNIXLIKE) && !defined (__CYGWIN__)) && !defined (__MACH__)
