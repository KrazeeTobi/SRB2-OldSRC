...
void G_PlayerReborn(int player)
{
	...
	auraitem = players[player].auraitem;
	...
	players[player].auraitem = auraitem;
...
//
void G_SaveGame(unsigned int slot, char* descriptiontxt)
{
	if(server)
...
//
void G_DeferedInitNew(skill_t skill, char* mapname, int pickedchar, boolean SSSG, boolean FLS)
{
	paused = false;
