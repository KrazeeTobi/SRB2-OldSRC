...
void D_SRB2Main(void)
{
...

	{
		...
		if(!userhome)
		{
#if (defined(LINUX) && !defined(__CYGWIN__) && !defined(DC) && !defined(PSP)) || defined(__MACH__) 
...
W_VerifyFileMD5( 0, "\x81\x0F\x9B\x3F\x87\xE6\x7E\x51\x06\xA6\xF7\x0F\x50\xA4\x49\xB9");//srb2.srb
...
W_VerifyFileMD5( 3, "\x24\xC9\x66\xE3\x4F\x2E\xBE\xB6\xB4\x16\xCB\x69\xD1\x67\xBE\xD2");//knux.plr
...
W_VerifyFileMD5(11, "\x94\x4F\x25\x65\x64\xD6\x9D\x14\xED\x52\xB5\x92\xAC\x20\xB5\x0A");//zim.dta
