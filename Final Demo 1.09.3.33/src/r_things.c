...
void SetPlayerSkinByNum(int playernum, int skinnum)
{
	if (skinnum < numskins) // Make sure it exists!
	{
		...
		if (atoi(skins[skinnum].spin) == 1)
			players[playernum].charflags |= SF_SPINALLOWED;

		if (atoi(skins[skinnum].super) == 1)
			players[playernum].charflags |= SF_ALLOWSUPER;

		if (atoi(skins[skinnum].runonwater) == 1)
			players[playernum].charflags |= SF_RUNONWATER;

		if (atoi(skins[skinnum].nojumpspin) == 1)
			players[playernum].charflags |= SF_NOJUMPSPIN;
		...
		if (atoi(skins[skinnum].multiability) == 1)
			players[playernum].charflags |= SF_MULTIABILITY;

		if (atoi(skins[skinnum].lightdash) == 1)
			players[playernum].charflags |= SF_LIGHTDASH;

		if (atoi(skins[skinnum].homing) == 1)
			players[playernum].charflags |= SF_HOMING;

		if (atoi(skins[skinnum].ringslinger) == 1)
			players[playernum].charflags |= SF_RINGSLINGER;

		players[playernum].slingitem = atoi(skins[skinnum].slingitem);

		players[playernum].thokitem = atoi(skins[skinnum].thokitem);
		players[playernum].spinitem = atoi(skins[skinnum].spinitem);

		players[playernum].waterskip = atoi(skins[skinnum].waterskip);
		...
		players[playernum].supercolor = atoi(skins[skinnum].supercolor)%MAXSKINCOLORS;
...
void R_AddSkins(int wadnum)
{
	...
	while ((lumpnum = W_CheckForSkinMarkerInPwad(wadnum, lastlump)) != -1)
	{
		...
		while (stoken)
		{
			...
			else if (!stricmp(stoken, "facename")) // Life icon name
			{
			...
			else if (!stricmp(stoken, "thrustfactor"))
			{
				strncpy(skins[numskins].thrustfactor, value, 1);
				strupr(skins[numskins].thrustfactor);
			}
			else if (!stricmp(stoken, "accelstart"))
			{
				strncpy(skins[numskins].accelstart, value, 3);
				strupr(skins[numskins].accelstart);
			}
			else if (!stricmp(stoken, "acceleration"))
			{
				strncpy(skins[numskins].acceleration, value, 2);
				strupr(skins[numskins].acceleration);
			}
			else if (!stricmp(stoken, "spin"))
			{
				strncpy(skins[numskins].spin, value, 1);
				strupr(skins[numskins].spin);
			}
			else if (!strcmp(stoken, "allowsuper"))
			{
				strncpy(skins[numskins].super, value, 1);
				strupr(skins[numskins].super);
			}
			else if (!strcmp(stoken, "superanims"))
			{
				strncpy(skins[numskins].superanims, value, 1);
				strupr(skins[numskins].superanims);
			}
			else if (!strcmp(stoken, "superspin"))
			{
				strncpy(skins[numskins].superspin, value, 1);
				strupr(skins[numskins].superspin);
			}
			else if (!strcmp(stoken, "supercolor"))
			{
				strncpy(skins[numskins].supercolor, value, 2);
				strupr(skins[numskins].supercolor);
			}
			else if (!strcmp(stoken, "runonwater"))
			{
				strncpy(skins[numskins].runonwater, value, 1);
				strupr(skins[numskins].runonwater);
			}
			else if (!strcmp(stoken, "nojumpspin"))
			{
				strncpy(skins[numskins].nojumpspin, value, 1);
				strupr(skins[numskins].nojumpspin);
			}
			else if (!strcmp(stoken, "multiability"))
			{
				strncpy(skins[numskins].multiability, value, 1);
				strupr(skins[numskins].multiability);
			}
			else if (!strcmp(stoken, "lightdash"))
			{
				strncpy(skins[numskins].lightdash, value, 1);
				strupr(skins[numskins].lightdash);
			}
			else if (!strcmp(stoken, "homing"))
			{
				strncpy(skins[numskins].homing, value, 1);
				strupr(skins[numskins].homing);
			}
			else if (!strcmp(stoken, "ringslinger"))
			{
				strncpy(skins[numskins].ringslinger, value, 1);
				strupr(skins[numskins].ringslinger);
			}
			else if (!strcmp(stoken, "slingitem"))
			{
				strncpy(skins[numskins].slingitem, value, 7);
				strupr(skins[numskins].slingitem);
			}
			else if (!strcmp(stoken, "thokitem"))
			{
				strncpy(skins[numskins].thokitem, value, 7);
				strupr(skins[numskins].thokitem);
			}
			else if (!strcmp(stoken, "spinitem"))
			{
				strncpy(skins[numskins].spinitem, value, 7);
				strupr(skins[numskins].spinitem);
			}
			else if (!strcmp(stoken, "waterskip"))
			{
				strncpy(skins[numskins].waterskip, value, 1);
				strupr(skins[numskins].waterskip);
			}
			else if (!strcmp(stoken, "actionspd"))
			{
				strncpy(skins[numskins].actionspd, value, 2);
				strupr(skins[numskins].actionspd);
			}
			else if (!strcmp(stoken, "mindash"))
			{
				strncpy(skins[numskins].mindash, value, 2);
				strupr(skins[numskins].mindash);
			}
			else if (!strcmp(stoken, "maxdash"))
			{
				strncpy(skins[numskins].maxdash, value, 2);
				strupr(skins[numskins].maxdash);
			}
			...
			else if (!stricmp(stoken, "startcolor"))
			{
				...
				snprintf(skins[numskins].endtranscolor,
					sizeof skins[numskins].endtranscolor,
					"%d", colorval);
			}
			else if (!strcmp(stoken, "endcolor")) // Not necessary, but if desired, must be defined after startcolor.
			{
				strncpy(skins[numskins].endtranscolor, value, 3);
				strupr(skins[numskins].endtranscolor);
			}

			else if (!strcmp(stoken, "prefcolor"))
			{
				strncpy(skins[numskins].prefcolor, value, 2);
				strupr(skins[numskins].prefcolor);
			}
			else if (!strcmp(stoken, "jumpheight"))
			{
				strncpy(skins[numskins].jumpfactor, value, 3);
				strupr(skins[numskins].jumpfactor);
			}
			else if (!strcmp(stoken, "boxindex"))
			{
