...
static inline void Interp1(Uint8 * pc, int c1, int c2)
{
#ifdef HQ2XASM
  //*((int*)pc) = (c1*3+c2)/4;
#ifdef __GNUC__
...
static inline void Interp2(Uint8 * pc, int c1, int c2, int c3)
{
#ifdef HQ2XASM
//  *((int*)pc) = (c1*2+c2+c3) >> 2;
#ifdef __GNUC__
...
static inline void Interp6(Uint8 * pc, int c1, int c2, int c3)
{
#ifdef HQ2XMMXASM
...
static inline void Interp7(Uint8 * pc, int c1, int c2, int c3)
{
#ifdef HQ2XMMXASM
 //*((int*)pc) = (c1*6+c2+c3)/8;
 if(hasMMX)
...
static inline void Interp9(Uint8 * pc, int c1, int c2, int c3)
{
#ifdef HQ2XMMXASM
...
static inline void Interp10(Uint8 * pc, int c1, int c2, int c3)
{
#ifdef HQ2XMMXASM
...
static inline int Diff(Uint32 w1, Uint32 w2)
{
#ifdef HQ2XMMXASM
 if(hasMMX)
 {
...
static inline void hq2x_32( Uint8 * pIn, Uint8 * pOut, int Xres, int Yres, int BpL )
{
  int  i, j, k;
...
static inline void InitLUTs(void)
{
