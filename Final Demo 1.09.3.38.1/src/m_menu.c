...
static void M_DrawStats(void)
{
	...
	if (eastermode)
	{
		...
		V_DrawCenteredString(BASEVIDWIDTH/2, 16, V_YELLOWMAP, va("Eggs Found: %i/%i", found, NUMEGGS));
	}
...
static void M_DrawControl(void)
{
	...
	for (i = 0;i < currentMenu->numitems;i++)
	{
		...
		V_DrawString(ControlDef.x+220-V_StringWidth(tmp), ControlDef.y + i*8,V_YELLOWMAP, tmp);
	}
