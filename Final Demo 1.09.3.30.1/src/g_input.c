...
static keyname_t keynames[] =
{
	...
	{KEY_DBL2JOY1+6, "DBLDOWN"    },
	{KEY_DBL2JOY1+7, "DBLLEFT"    },
	{KEY_DBL2JOY1+8, "DBLUP"      },
	{KEY_DBL2JOY1+9, "DBLRIGHT"   },
	{KEY_DBL2JOY1+10,"DBLSELECT"  },
	{KEY_DBL2JOY1+11,"DBLSTART"   },
	{KEY_DBL2JOY1+12,"DBLHOME"    },
	{KEY_DBL2JOY1+13,"DBLHOLD"    },
#else
...
void G_Controldefault(void)
{
	gamecontrol[gc_forward    ][0] = KEY_JOY1+8;
	gamecontrol[gc_backward   ][0] = KEY_JOY1+6;
	//gamecontrol[gc_strafe     ][0] =;
	gamecontrol[gc_turnleft   ][0] = KEY_JOY1+7;
	gamecontrol[gc_turnright  ][0] = KEY_JOY1+9;
	gamecontrol[gc_fire       ][0] = KEY_JOY1+5;
	gamecontrol[gc_firenormal ][0] = KEY_JOY1+4;
	gamecontrol[gc_lightdash  ][0] = KEY_JOY1+2;
	gamecontrol[gc_use        ][0] = KEY_JOY1+1;
	gamecontrol[gc_taunt      ][0] = KEY_JOY1+10;
	//gamecontrol[gc_camleft    ][0] = 'o';
	//gamecontrol[gc_camright   ][0] = 'p';
	gamecontrol[gc_camreset   ][0] = KEY_JOY1+3;
	//gamecontrol[gc_lookup     ][0] = KEY_PGUP;
	//gamecontrol[gc_lookdown   ][0] = KEY_PGDN;
	gamecontrol[gc_centerview ][0] = KEY_JOY1+13;
	//gamecontrol[gc_mouseaiming][0] = 's';
	//gamecontrol[gc_talkkey    ][0] = 't';
	gamecontrol[gc_scores     ][0] = KEY_JOY1+11;
	gamecontrol[gc_jump       ][0] = KEY_JOY1;
	//gamecontrol[gc_console    ][0] = KEY_CONSOLE;
}
#else
void G_Controldefault(void)
