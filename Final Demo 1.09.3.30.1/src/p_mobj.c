...
void P_SpawnMapThing(mapthing_t *mthing)
{
	...
	if (mthing->type != 52 && mthing->type != 53 && mthing->type != 59
		...
		&& mthing->type != 82 && mthing->type != 3006 && mthing->type != 72)
	{
		unsigned int bit;
	...
	if (mthing->type == 52 || mthing->type == 53 || mthing->type == 59
		|| mthing->type == 62 || mthing->type == 15 || mthing->type == 61
		|| mthing->type == 45 || mthing->type == 46 || mthing->type == 55
		|| mthing->type == 73 || mthing->type == 72)
	{
		// Mare it belongs to
		...
		// Set the MF2 flag
		if (i == MT_AXIS1 || i == MT_AXIS1A || i == MT_AXIS2
			|| i == MT_AXIS2A || i == MT_AXIS3 || i == MT_AXIS3A || i == MT_CUSTOMAXIS)
		{
	...
	else
	{
		if (mthing->options & MTF_AMBUSH)
		{
			...
			if (mthing->type != 52 && mthing->type != 53 && mthing->type != 59
				...
				&& mthing->type != 85 && mthing->type != 3006 && mthing->type != 72)
				mobj->flags |= MF_AMBUSH;
		}
