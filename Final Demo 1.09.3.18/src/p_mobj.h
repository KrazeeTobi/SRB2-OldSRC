...
typedef enum
{
	...
	MF2_CLASSICPUSH    =     0x02000000, // Drops straight down when object has negative Z.
	MF2_NOCLIPHEIGHT   =     0x04000000, // Don't adjust z if below or above floorz/ceilingz
} mobjflag2_t;
