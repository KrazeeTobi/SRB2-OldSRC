...
void D_SRB2Main(void)
{
	...
	{
		if((modifiedgame && !savemoddata) || netgame || cv_debug)
		{
...
W_VerifyFileMD5( 0, "\x03\x0F\x4F\x56\x4D\xB8\x71\x17\x7E\x44\x37\x21\x06\xA3\xE1\x5B");//srb2.srb
W_VerifyFileMD5( 1, "\x5B\x70\x61\x4B\xD8\x7B\xAD\x9A\x9E\x11\xEA\x71\x90\xA1\x08\xF7");//sonic.plr
W_VerifyFileMD5( 2, "\xE1\x1F\x0F\xF5\x65\x51\xCE\xCA\x77\xD5\x85\x9E\xE1\xF8\x8A\x7D");//tails.plr
W_VerifyFileMD5( 3, "\x55\x3D\x30\x0A\x7A\xF2\x38\x2F\x92\x83\x00\x73\x32\xA8\x52\xF4");//knux.plr
...
if(xmasmode)
{
W_VerifyFileMD5(12, "\x1C\x8F\xE1\x5A\x46\xA6\x4B\x17\x46\x1B\xDD\x17\x3C\xAF\xBB\xA2");//3drend.dll
}
