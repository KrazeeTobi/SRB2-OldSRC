...
void G_DeferedInitNew(skill_t skill, const char* mapname, int pickedchar, boolean SSSG, boolean FLS); // Tails 03-02-2002
...
void G_DoSaveGame(unsigned int slot, const char* descriptiontxt);
void G_SaveGame(unsigned int slot, const char* savedescription);
